...
export default function Work({ slug }: PostProps) {
  const Sketch = dynamic<{
    predictionsRef: React.MutableRefObject<handPoseDetection.Hand[] | null>;
  }>(() => import(`../../sketches/${slug}.tsx`), {
...
export async function getStaticPaths() {
  const slugs = await fetchSketchSlugs();

  return {
    paths: slugs?.map((slug) => ({
      params: { slug: slug.replace(/\.tsx$/, "") },
    })),
    fallback: false,
  };
}
